...
async def get_storefront_layout(db: AsyncSession = Depends(get_db)):
    ...
    terms_conditions = settings_map.get("terms_conditions", {
        ...
        "contentHtml": "<h2>1. Terms of Use</h2><p>Welcome to Kozmocart. By using this storefront or subscribing to our concierge, you agree to comply with our commercial terms and local statutory mandates.</p><h2>2. Purchase Agreements & Cancellations</h2><p>Due to the exclusive nature of limited luxury fragrances, catalog prices are subject to dynamic correction. We reserve full rights to cancel suspicious bulk transactions.</p><h2>3. Intellectual Assets</h2><p>All brand titles, custom product photography, fluid obsidian illustrations, and Nelphim type styles are protected under national copyright regulations.</p>"
    })
