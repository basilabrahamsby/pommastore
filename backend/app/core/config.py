...
class Settings(BaseSettings):
    ...
    SMTP_TLS: bool = True
    SMTP_SSL: bool = False
    ADMIN_EMAIL: str = "sales@poshgallery.ae"

    ALLOWED_ORIGINS: List[str] = [
        "http://localhost:5173",
        "http://localhost:3000",
        "https://pommastore.com",
        "http://pommastore.com",
        "https://www.pommastore.com",
        "http://www.pommastore.com",
        "https://pommaholidays.com",
        "http://pommaholidays.com",
        "https://www.pommaholidays.com",
        "http://www.pommaholidays.com",
        "https://teqmates.com",
        "http://teqmates.com",
